...
$nomenclature = $pdo->query($sql);
$nomenclature = $nomenclature->fetch();
?>
<head>
    <meta charset="UTF-8">
...
<body id='body-index'>
    ...
    <div class="container">
        ...
        <?php if (!empty($nomenclature)): ?>
                <div class="product">
                    <h3><?php echo htmlspecialchars($nomenclature['id_produit']); ?></h3>
                    <p><?php echo htmlspecialchars($nomenclature['id_composant']); ?></p>
                    <p><?php echo htmlspecialchars($nomenclature['quantite']); ?></p>
                </div>
        <?php else: ?>
